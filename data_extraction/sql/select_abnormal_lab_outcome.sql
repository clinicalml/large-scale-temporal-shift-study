DROP TABLE IF EXISTS {schema_name}.lab_{outcome_id}_{direction}_outcomes{debug_suffix};
CREATE TABLE {schema_name}.lab_{outcome_id}_{direction}_outcomes{debug_suffix} AS
WITH cohort_ids AS (
