...
def select_top_procedure_outcomes(number_outcomes,
                                  outcome_file):
    '''
    Select most frequent procedure outcomes in the cohort
    ...
    with open('sql/select_top_procedure_outcomes.sql', 'r') as f:
        top_feat_sql = f.read()
...
if __name__ == '__main__':
    ...
    number_outcomes = 100
    output_dir = config.outcome_data_dir
    
    select_top_procedure_outcomes(number_outcomes,
                                  output_dir + 'top_procedures_in_cohort.txt')